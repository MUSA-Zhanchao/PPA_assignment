...
As the results of the model of mean absolute error (MAE), root mean squared error (RMSE), and R-squared are improved, the dummy variables are significant to the model.
